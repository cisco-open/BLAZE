...
from drag.layouts import dropdown_data_inputs, dropdown_models_inputs, dropdown_ui_inputs, get_schema
import yaml
...
def get_callbacks(app):
    ...
    def update_elements(
        ...
        # COMPONENT 05 - Selecting "Upload" button
            ...
            test_title, test_elements = build_elements(
                upload_filename, upload_content)
    ...
    def display_edge_tab_content(new_label, toggle_custom, toggle_benchmark, toggle_comparison, edges):
        ...
        print(
            f"Current: {flags} vs Toggles: {toggle_custom} {toggle_benchmark} {toggle_comparison}")
        if toggle_custom or toggle_benchmark or toggle_comparison:
            g.design.update_toggle(
                edges[0], toggle_custom, toggle_benchmark, toggle_comparison)
